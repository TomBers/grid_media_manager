...
#
#     PHX_SERVER=true bin/grid_media_manager start
#
...
config :grid_media_manager, :pexels, api_key: System.get_env("PEXELS_API_KEY")
...
if config_env() == :prod do
  ...
  config :grid_media_manager, GridMediaManager.Repo,
    # ssl: true,
    url: database_url,
  ...
  config :grid_media_manager, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :grid_media_manager, GridMediaManager.Mailer,
